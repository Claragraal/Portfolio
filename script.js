...
function toggleRole() {
    ...
    if (isDeveloper) {
        ...
        // Append the content for the third part of "about me"
        ...
        roleText.textContent = 'Developer (WIP)';
...
// Add click event listener to the switch button initially
const switchButton = document.querySelector('.switch-button');
